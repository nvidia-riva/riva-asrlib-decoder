...
def unigram2words(arpa_file: str):
    word_list = []
    entity_list = []
    skipped_list = []
    unigram_count = get_unigram_count(arpa_file)
    ...
    return word_list, entity_list, skipped_list

if __name__ == "__main__":
    arpa_file = open(sys.argv[1], 'r')
    vocab_folder = sys.argv[2]
    word_list, entity_list, skipped_list = unigram2words(arpa_file)
